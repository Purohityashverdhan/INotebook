...
const Notes = (props) => {
    ...
    const updateNote = (currentNote) => {
        console.log("Updating", currentNote);
        ref.current.click();
        setNote({
            id:currentNote._id,
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h1 className="modal-title fs-5" id="exampleModalLabel">Modal To update existing Note</h1>
                        ...
                        <div className="modal-body">
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="email" className="form-control" id="etitle" name="etitle"
                                     value={note.etitle} aria-labelledby="emailHelp" onChange={onChange} minLength={5} required/>
                                </div>
                                <div className="mb-3">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length<5 || note.edescription.length<5} onClick={handleClick} type="button"
